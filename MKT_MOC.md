...
- NGFS: `MKT-NGFS-01..07` (rate as a **shock not a level**; two anchors + the ST-grain adaptation; ST-first connector shipped 2026-08-02 with the WEO-anchored baseline delta, the HWTP/SWUC+DAPS set, and the first transition results — `INT-29/30`).
