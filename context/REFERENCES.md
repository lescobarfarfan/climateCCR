...
- **`[ContTankov2004]`** — Cont, R., & Tankov, P. (2004). *Financial Modelling with Jump Processes.* Chapman & Hall/CRC. DOI: 10.1201/9780203485217 — Backs `HAZ-STOCH-02`.
...
- **`[AndersenPiterbarg2010]`** — Andersen, L., & Piterbarg, V. (2010). *Interest Rate Modeling* (Vols. I–III). Atlantic Financial Press. — Backs `MKT-IR-01` and the HW1F simulation scheme PIMPA uses (`CCR` `processes`). *(Confirm volume/page on citation.)*
