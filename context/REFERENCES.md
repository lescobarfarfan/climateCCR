...
- **`[AndersenPiterbarg2010]` / `[JamesWebber2000]` / `[Yasuoka2018]` / `[Compagnoni2023]` / `[Lyons1998]`** — standard texts/papers cited above with edition/venue/pages still to pin down precisely (`[Gregory_xVA]` pinned 2026-07-25). (→ `OQ-MKT-05`, `OQ-CCR-05`)
